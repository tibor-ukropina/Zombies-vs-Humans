...
{
    // Counters for each type of entity (zombie, human, etc.) in the simulation.
    ...
    /**
     * Generate counts of the number of zombies and humans.
     * These are not kept up to date as zombies and humans
